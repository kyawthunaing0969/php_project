...
<body>
    ...
    <p class="mx-4 mt-4">Our online examination system provides innovative and impeccable solutions for exams throughout various colleges, universities, educational institutions, and many leading corporate entities.</p><p class="mx-4"> Conduct Exam is developed by a highly qualified team and specialized in creating high impact online exam software which is highly efficient in terms of reliability and speed.</p>

    <p class="mx-4">With our online examination system, anyone can conduct online exams or tests easily, and a team of innovators constantly research on making the procedure of exam simple & easy.</p><p class="mx-4 mb-5"> Conduct Exam aims to help the students and the clients, such as companies and universities, to transcend the time constraints and geographical boundaries with a highly skilled administrator and monitor. Complete and precise information on the exam is available on the portal.</p>

    <!--Footer start-->
    <!-- <div class="row footer">
        <div class="col-md-4 box logochay">
            <a href="aboutus.php" style="color:chartreuse"  id="about" target="_blank">ကျွန်ုပ်တို့အ​ကြောင်း</a>
        </div>
        <div class="col-md-4 box">
            <a href="ourplan.php" style="color:chartreuse" id="our">ကျွန်ုပ်တို့​မျှော်မှန်းချက်</a>
        </div> -->
        <!-- <div class="col-md-4 box">
